---
title: XFlash DA Protocol
---

## General Info

The XFlash DA Protocol (also known as V5 DA Protocol) is the communication protocol used by [Download Agent](download_agent.mdx) in MediaTek devices to interact with the device during Download Mode.
It is an evolution of the older Legacy DA Protocol (which seem to be labeled as V3), which will also be the foundation for the later [XML DA Protocol](xml_da_protocol.md) (V6).
...
To these, with [DA Extensions](da_extensions.md), a new range was added:
